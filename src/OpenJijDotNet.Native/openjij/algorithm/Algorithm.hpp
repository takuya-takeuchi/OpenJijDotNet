...
//         float_template(error, __UPDATERTYPE__, __ISINGTYPE__, graph::Dense,  __RNG__, __VA_ARGS__);\
//         break;\
//     case ::graph_types::Sparse:\
//         float_template(error, __UPDATERTYPE__, __ISINGTYPE__, graph::Sparse, __RNG__, __VA_ARGS__);\
//         break;\
//     default:\
...
DLLEXPORT int32_t algorithm_Algorithm_run(const updater_types updater_type,
                                          ...
                                          const updater_types float_type,

...
\
DLLEXPORT int32_t graph_Dense_##__TYPENAME__##_get_J(graph::Dense<__TYPE__> *dense, \
                                                     const uint32_t i, \
                                                     const uint32_t j, \
                                                     __TYPE__* value)\
{\
...
\
DLLEXPORT int32_t graph_Dense_##__TYPENAME__##_set_J(graph::Dense<__TYPE__> *dense, \
                                                     const uint32_t i, \
                                                     const uint32_t j, \
...
\
DLLEXPORT int32_t graph_Dense_##__TYPENAME__##_get_h(graph::Dense<__TYPE__> *dense, \
                                                     const uint32_t i, \
                                                     __TYPE__* value)\
{\
    *value = dense->h(i);\
...
\
DLLEXPORT int32_t graph_Dense_##__TYPENAME__##_set_h(graph::Dense<__TYPE__> *dense, \
                                                     const uint32_t i, \
                                                     const __TYPE__ value)\
{\
    dense->h(i) = value;\
